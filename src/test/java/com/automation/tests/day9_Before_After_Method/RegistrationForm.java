package com.automation.tests.day9_Before_After_Method;
...
public class RegistrationForm {
    ...
    public void test1(){
        ...
        driver.findElement(emailBy).sendKeys("test@mail.com");
        driver.findElement(passwordBy).sendKeys("12345678910");
